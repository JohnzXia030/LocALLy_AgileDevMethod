$(document).ready(function () {
        ...
        for (var i = 0 ; i < orders.length ; i++) {
          ...
          var construct =
            '<li class="items odd" data-idorder="' + idOrder + '">' +
              '<div class="infoWrap row">' +
                '<div class="cartSection col-7">' +
                  ...
                  '</div>' +
                '</div>' +
                '<div class="prodTotal cartSection col-3">' +
                ...
                '</div>' +
              '</div>' +
              '<div class="infoWrap m-3 mb-0 col-2">' +
  ...
  $('a.currentOrders').click(function(e) {
    e.preventDefault();
